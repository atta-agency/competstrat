    ...
    <div class="row">
      <div class="col-sm-8">
        ...
        <div class="list_social_footer">
          <ul class="list-unstyled">
            ...
            <li><a href="mailto:atta.infos@gmail.com"><small><i class="fa fa-envelope"></i> krilltonic@gmail.com</small></a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-sm-4">
        <ul class="list-unstyled list-inline social-list">
          <li>
            <a href="https://www.facebook.com/krilltonic?fref=ts">
              <i class="fa fa-facebook"></i><br/>
              <p>facebook</p>
            </a>
          </li> 
          <li>
            <a href="https://twitter.com/KrillTonic">
